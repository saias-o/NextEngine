...
// EXACT set 0/1 + push-constant layout of the Lit pipeline, so the Renderer
...
// bindings (lighting, shadows, GI) stay out of this stage, which is exactly why
// unlit is cheaper than Lit.
//
...
// the vertex stage (world pos, normal, secondary UV) are simply not declared.
