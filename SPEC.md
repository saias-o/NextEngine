...
Mise à jour : 2026-07-24. Ce document est la vérité technique du moteur. Il
décrit ce qui existe réellement, les contrats candidats V1 et les limites. Les
travaux à effectuer vivent uniquement dans [ROADMAP.md](ROADMAP.md).
...
publiées en [§17](#17-support-promotion-et-retrait-dune-release). La promotion
...
## 17. Support, promotion et retrait d'une release

Guide opérationnel de release. La checklist de ce qui reste à faire est dans
[ROADMAP.md](ROADMAP.md).

### 17.1 Matrice de support V1
...
### 17.2 Non supporté ou non qualifié
...
### 17.4 Retrait et retour à la version précédente
