...
void BuildController::draw(Project* project) {
    ...
    // Keep footer and result panel visible while both columns scroll.
                      ...
                      ImGuiChildFlags_Borders);
    {
        ...
        if (selectedPlatform_ == BuildPlatform::Windows) {
            ...
            ImGui::Checkbox("Enable Link-Time Optimization (LTO / -O3)",
                            &enableLto_);
        } else if (selectedPlatform_ == BuildPlatform::MetaQuest) {
        ...
        } else if (selectedPlatform_ == BuildPlatform::Linux) {
            ...
            ImGui::Checkbox(
                ...
                &enableLto_);
        } else if (selectedPlatform_ == BuildPlatform::WebGL) {
